...
[CLI installation steps](../installation). Below you will learn how to use
...
`npx all-contributors-cli init` route a try 😺.
</Aside>
...
? What are the contribution types? 💬  Answering Questions, 📝  B
logposts, 💻  Code
```
